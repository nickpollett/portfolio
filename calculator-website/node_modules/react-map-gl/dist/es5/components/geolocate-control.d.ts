...
declare const _default: React.MemoExoticComponent<(<GeolocateControlOptions, ControlT extends GeolocateControlInstance>(props: GeolocateControlOptions & {
    /** Placement of the control relative to the map. */
    position?: ControlPosition;
    /** CSS style override, applied to the control's container */
    style?: React.CSSProperties;
    ...
    /** Called when the GeolocateControl changes to the background state. */
    onTrackUserLocationEnd?: (e: GeolocateEvent<ControlT>) => void;
} & React.RefAttributes<ControlT>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>)>;
